<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 235.5 33.2">
    ...
    <text transform="translate(32 25)" style="font-size: 26px">
      <tspan fill="currentColor" x="6" y="0">SSE</tspan>
      <tspan x="53" y="0" fill="#10aa50" opacity="1">W</tspan>
      <tspan x="76" y="0" fill="#10aa50" opacity=".8">o</tspan>
      <tspan x="91" y="0" fill="#10aa50" opacity=".7">r</tspan>
      <tspan x="102" y="0" fill="#10aa50" opacity=".6">l</tspan>
      <tspan x="110" y="0" fill="#10aa50" opacity=".5">d</tspan>
    </text>
  </svg>
</template>
