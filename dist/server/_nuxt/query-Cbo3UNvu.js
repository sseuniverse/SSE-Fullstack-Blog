import { as as useRuntimeConfig, at as useRequestEvent } from "../server.mjs";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-UUDo528O.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-Cbo3UNvu.js.map
